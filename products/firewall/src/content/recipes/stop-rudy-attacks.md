...
The first expression uses the `http.request.uri.path` [field](https://secret.wiki/firewall/cf-firewall-language/fields#standard-fields) to target the paths to secure from R.U.D.Y.:
