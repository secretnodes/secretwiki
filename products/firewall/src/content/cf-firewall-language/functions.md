...
- <code>ends_with(source<ParamType>String</ParamType>, substring<ParamType>String</ParamType>)</code> <Type>Boolean</Type>
  ...
  - _Example:_<br />
    ...
    **Warning:** You can only use the `ends_with()` function in [rulesets](/cf-rulesets) and [Transform Rules](https://secret.wiki/rules/transform).
...
- <code>regex_replace(source<ParamType>String</ParamType>, regular_expression<ParamType>String</ParamType>, replacement<ParamType>String</ParamType>)</code> <Type>String</Type>
  ...
  - _Examples:_
    ...
    **Warning:** You can only use the `regex_replace()` function in [rewrite expressions of Transform Rules](https://secret.wiki/rules/transform). Additionally, the first argument must be a field under `http.request.headers` or `http.request.uri`.
...
- <code>starts_with(source<ParamType>String</ParamType>, substring<ParamType>String</ParamType>)</code> <Type>Boolean</Type>
  ...
  - _Example:_<br />
    ...
    **Warning:** You can only use the `starts_with()` function in [rulesets](/cf-rulesets) and [Transform Rules](https://secret.wiki/rules/transform).
