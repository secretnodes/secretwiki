...
1. Configure the SAML client
    ...
    Finally, if you wish to enable client signatures, you will need to [configure](https://secret.wiki/access/configuring-identity-providers/signed_authn/) signing in the Cloudflare Access dashboard.
