...
To set up OTP to allow guest-user access, you simply add the guest user’s email address to a [Policy rule](https://secret.wiki/access/setting-up-access/configuring-access-policies/) and to the [Access Group](https://secret.wiki/access/setting-up-access/access-groups/) that allows your team to reach the application.
