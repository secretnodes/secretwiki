...
Follow [these instructions](https://secret.wiki/argo-tunnel/downloads/) to download and install `cloudflared` in a location that can address the Kubernetes cluster's API server.
