...
- Configure [Logpush](https://secret.wiki/logs/logpush/)
...
1. Configure Cloudflare [Logpush](https://secret.wiki/logs/logpush/) to push logs with all desired fields to an AWS S3 bucket of your choice.
...
Firewall Rule, configured with the action _Challenge (Captcha)_. To lear more, consult the [Cloudflare Firewall Rules documentation](https://secret.wiki/firewall/cf-firewall-rules/).
</Aside>
