...
- By default, we use Node 10 in the Pages build environment. If you need to use a newer Node version, see our [Build configuration page](https://secret.wiki/pages/platform/build-configuration) for configuration options.
